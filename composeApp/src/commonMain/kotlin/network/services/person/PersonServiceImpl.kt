...
class PersonServiceImpl(private val client: HttpClient) : PersonService {
    override suspend fun getPersonDetailsById(personId: Int, language: String): ApiResult<PersonResponse> {
    ...
    override suspend fun getPersonCreditsById(personId: Int, language: String): ApiResult<PersonCreditsResponse> {
