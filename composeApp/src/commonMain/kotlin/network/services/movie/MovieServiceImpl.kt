...
class MovieServiceImpl(private val client: HttpClient) : MovieService {
    ...
    override suspend fun getMovieDetailsById(movieId: Int, language: String): ApiResult<MovieResponse> {
    ...
    override suspend fun getMovieCreditsById(movieId: Int, language: String): ApiResult<ContentCreditsResponse> {
    ...
    override suspend fun getMovieVideosById(movieId: Int, language: String): ApiResult<VideosByIdResponse> {
